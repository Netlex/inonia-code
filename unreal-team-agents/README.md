...
- `bEnableAutoToolRouting` (вкл/выкл авто-роутинг инструментов).
...
В UI есть переключатель **Auto tool routing**, который позволяет быстро включать/выключать авто-роутинг без перезапуска.
